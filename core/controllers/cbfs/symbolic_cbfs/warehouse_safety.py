...
h_hs_symbolic = (ss[0] - (ss[1] - intercept) / slope) * (ss[0] + (ss[1] + intercept) / slope)
...
h_phs_symbolic = ((ss[0] + vx * tau) - ((ss[1] + vy * tau) - intercept) / slope) * ((ss[0] + vx * tau) + ((ss[1] + vy * tau) + intercept) / slope)
