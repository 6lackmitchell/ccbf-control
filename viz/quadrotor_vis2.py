...
from quadrotor.settings import OBS_X1, OBS_X2, OBS_Y1, OBS_Y2, OBS_R, ALT_LO, ALT_HI, U_MAX
...
ax1.plot(t[1:ii],sols[1:ii,ecc,3],label='d1',linewidth=lwidth,color=colors[ecc+1])
ax1.plot(t[1:ii],sols[1:ii,ecc,4],label='d2',linewidth=lwidth,color=colors[ecc+2])
ax1.plot(t[1:ii],sols[1:ii,ecc,2],label='d0',linewidth=lwidth,color=colors[ecc])
ax1.legend(fancybox=True)
...
ax2a.plot(t[1:ii],U_MAX[0]*np.ones(t[1:ii].shape),label=r'$\pm\bar{u}_x$',linewidth=lwidth,color='k')
ax2a.plot(t[1:ii],-U_MAX[0]*np.ones(t[1:ii].shape),linewidth=lwidth,color='k')
ax2a.plot(t[:ii],sols[:ii,ecc,0],label='PRO',linewidth=lwidth,color=colors[ecc])
ax2a.set(ylabel=r'$u_{x}$',xlim=[-0.1,5.2],ylim=[-U_MAX[0]-0.5,U_MAX[0]+0.5])#,title='Control Inputs')
...
ax2b.plot(t[1:ii],U_MAX[0]*np.ones(t[1:ii].shape),label=r'$\pm\bar{u}_y$',linewidth=lwidth,color='k')
ax2b.plot(t[1:ii],-U_MAX[0]*np.ones(t[1:ii].shape),linewidth=lwidth,color='k')
ax2b.plot(t[:ii],sols[:ii,ecc,1],label='PRO',linewidth=lwidth,color=colors[ecc])
ax2b.set(xlabel='Time (sec)',ylabel=r'$u_{y}$',xlim=[-0.1,5.2],ylim=[-U_MAX[0]-0.5,U_MAX[1]+0.5])
...
ax2a.set(ylabel='PN')#,title='Control Inputs')
for item in ([ax2a.title, ax2a.xaxis.label, ax2a.yaxis.label] +
             ax2a.get_xticklabels() + ax2a.get_yticklabels()):
    item.set_fontsize(25)
ax2a.legend(fancybox=True)
...
ax2b.set(xlabel='Time (sec)',ylabel='PE')
for item in ([ax2b.title, ax2b.xaxis.label, ax2b.yaxis.label] +
             ax2b.get_xticklabels() + ax2b.get_yticklabels()):
    item.set_fontsize(25)
ax2b.legend(fancybox=True)
...
# ax2c  = fig1.add_subplot(grid[1,1])
ax2c.spines['bottom'].set_color('#000000')
ax2c.spines['top'].set_color('#000000')
ax2c.spines['right'].set_color('#000000')
ax2c.spines['left'].set_color('#000000')
# ax2c.plot(t[:ii],sols[:ii,tay,1],label='TAY',linewidth=lwidth,color=colors[tay])
# ax2c.plot(t[:ii],sols[:ii,bla,1],label='BLA',linewidth=lwidth,color=colors[bla])
# ax2c.plot(t[:ii],sols[:ii,lop,1],label='LOP',linewidth=lwidth,color=colors[lop])
# ax2c.plot(t[:ii],sols[:ii,lsm,1],label='LSM',linewidth=lwidth,color=colors[lsm])
# ax2c.plot(t[:ii],sols[:ii,zha,1],label='ZHA',linewidth=lwidth,color=colors[zha])
