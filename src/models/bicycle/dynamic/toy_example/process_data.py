...
filepath = "/Users/mblack/Downloads/"
filename = filepath + "humans_in_scene.pkl"
...
# xe_interp = np.interp(t_new, t, xe[:, 0:2])
# xh_interp = np.interp(t_new, t, xh[:184, 0:2])


# # Plot norm of positions
# fig, axp = plt.subplots()

# # pointwise norm between two vectors python
# # axp.plot(t_new, np.abs(xe_interp - xh_interp))

# # plot the norm of the positions
# axp.plot(t_new, np.linalg.norm(xe_interp - xh_interp, axis=1), label="Norm of Positions")
# axp.set_xlabel("Time (s)")
# axp.set_ylabel("Distance between Human and Agent (m)")
# axp.legend()
