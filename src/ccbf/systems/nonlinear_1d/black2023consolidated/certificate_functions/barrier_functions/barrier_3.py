...
def cbf(limit, **kwargs) -> Callable[[Array], Array]:
    ...
    def func(state_and_time: Array) -> Array:
        ...
        """
        x = state_and_time
        return limit**2 - x[0] ** 2

    return func


def cbf_grad(limit, **kwargs) -> Callable[[Array], Array]:
...
@jit
def cbf_hess(limit, **kwargs) -> Callable[[Array], Array]:
